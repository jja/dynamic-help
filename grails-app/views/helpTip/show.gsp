            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="helpTip.controller.label" default="Controller" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: helpTipInstance, field: "controller")}</td>
